...
urlpatterns = [
    ...
    path('updateuevent/<ueventid>/', views.update_uevent),
    path('deleteuevent/<ueventid>/', views.delete_uevent),
    path('pevents/', views.past_events),
    path('updatepevent/<peventid>/', views.update_pevent),
    path('deletepevent/<peventid>/', views.delete_pevent),
